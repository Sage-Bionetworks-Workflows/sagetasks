...
Welcome to `sagetasks` contributor's guide.
...
If you experience bugs or general issues with `sagetasks`, please have a look
...
You can help improve `sagetasks` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`sagetasks` documentation uses [Sphinx] as its main documentation compiler.
...
:::{tip}
   ...
   propose changes in `sagetasks`'s files. While this mechanism can
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:sage-bionetworks-workflows/sagetasks.git
   cd sagetasks
   ```
...
5. Install [pre-commit] hooks:
   ...
   `sagetasks` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/sage-bionetworks-workflows/sagetasks
[issue tracker]: https://github.com/sage-bionetworks-workflows/sagetasks/issues
